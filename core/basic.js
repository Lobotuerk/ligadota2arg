...
let actions = {
  ...
  lfg: function(source, fromUser) {
    ...
    if (res) {
      msg.reply(source, DICT.LFG_RESPONSES.lfg_response_sender);
    }
  },
  ...
  inhouse: function(source, fromUser, input) {
    ...
    if (res) {
      msg.reply(source, DICT.INHOUSE_RESPONSES.inhouse_response_sender);
    }
  },
  ...
  help: function(source) {
    ...
    msg.reply(source, helpFunction(isAdmin));
  },

  mute: function(source) {
    msg.reply(source, DICT.mute_response);
    friends.setMute(source, true);
  },

  unmute: function(source) {
    friends.setMute(source, false);
    msg.reply(source, DICT.unmute_response);
  },
  ...
  whois: function(source, input) {
    ...
    if (lookupID) {
      ...
      msg.reply(source, friendInfo);
    } else {

      // No friend found :(
      msg.reply(source, 'I couldn\'t find any user I know with a name similar to ' +
        input + '. Sorry :(');
    }
  }
